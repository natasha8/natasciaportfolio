...
function EduCard({ education }: Props) {
    ...
    return (
        <motion.article initial={{ opacity: 0 }}
            ...
            viewport={{ once: true }}
            className="w-full lg:w-1/3 flex flex-col rounded-lg justify-center items-center space-y-2 lg:space-y-6 
        ...
        >
            ...
            <div className="h-[75%] px-5 pt-4 md:px-10 bg-[#fcdef8]/20 rounded-xl">
                <div className="h-[20%]">

                    <p className="font-bold text-center lg:text-2xl mt-1">
